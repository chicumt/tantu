...
public interface EletricDao {
    ...
    Integer getTodayMount(List<Long> ids);

    EletricVO getToday(List<Long> ids);

    EletricVO getTotal(List<Long> ids);
    List<DataChart> getTodayChart();

    List<DataChart> getRecentChart();
